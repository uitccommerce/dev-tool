...
namespace Uitccommerce\DevTool\Commands;

use Uitccommerce\DevTool\Commands\Abstracts\BaseMakeCommand;
...
class PackageCreateCommand extends BaseMakeCommand implements PromptsForMissingInput
{
    public function handle(): int
    {
        ...
        $this->line(
            '<info>Add</info> <comment>"uitccommerce/' . $package . '": "*@dev"</comment> to composer.json then run <comment>composer update</comment> to install this package!'
        );
        $this->line('------------------');
